        ...
        if message.content.startswith(f"<@{self.user.id}>") or message.content.lower().startswith("sprk"):
            ...
            async with message.channel.typing():
                ...
                system_instruction = (
                    ...
                    "Также упомяни что ты находишься в разработке и могут быть небольшие баги. И ещё обращайся к пользователю на том же языке, что и он. Если его запрос на английском, значит весь твой ответ должен быть на английском."
                )
